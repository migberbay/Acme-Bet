...
<form:form action="curricula/endorserRecord/edit.do" modelAttribute="endorserRecord">

	<form:hidden path="id"/>
	<form:hidden path="version"/>
	
	<acme:textbox code="record.endorserName" path="endorserName"/>
	<acme:textbox code="record.email" path="email"/>
	<acme:textbox code="record.phone" path="phone"/>
	<acme:textbox code="record.linkedInProfile" path="linkedInProfile"/>
