...
<security:authorize access="hasRole('ADMIN')">
	<form:form action="admin/configuration.do" modelAttribute="configurationForm">

	<acme:textbox path="systemName" code="admin.systemName"/>
	<acme:textbox path="banner" code="admin.banner"/> 
	<acme:textbox path="finderCacheTime" code="admin.finderCacheTime"/>
	<acme:textbox path="vatPercentage" code="admin.vatPercentage"/>
	<acme:textbox path="sponsorshipFare" code="admin.fare"/>
	<acme:textbox path="freeFunds" code="admin.freeFunds"/>
	<acme:textbox path="defaultPhoneCode" code="admin.defaultPhoneCode"/>
	<acme:textbox path="finderQueryResults" code="admin.finderQueryResults"/>
