package controllers.bookmarker;
...
@Controller
@RequestMapping("bookmaker/warranty")
public class BookmarkerWarrantyController extends AbstractController {
	...
	public ModelAndView list() {
		...
		warranties = warrantyService.findByPrincipal();
		
		result = new ModelAndView("warranty/list");
		result.addObject("warranties", warranties);
		result.addObject("requestURI", "bookmaker/warranty/list.do");
	...
	public ModelAndView edit(@RequestParam final int warrantyId) {
		...
		if (warrantyService.findByPrincipal().contains(warranty) && warranty.getIsFinal()==false) {
			result = this.createEditModelAndView(warranty);
		}else{
